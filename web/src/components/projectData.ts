...
export interface ProjectPageData {
    ...
    heroImage: string;
    gallery: (string | { type: 'video'; url: string; thumbnail: string } | { type: 'image'; url: string; overlay?: string; href?: string; buttonText?: string })[];
    challenge: string;
    solution: string;
    role: string;
    timeline: string;
...
export const defaultPageContent: Record<number, ProjectPageData> = {
    1: {
        ...
        heroImage: "",
        gallery: ["/Project-add-image/Id Card Mockup.jpg", "/Project-add-image/Id Card Mockup 2.jpg", "/Project-add-image/nw yr 1.jpg", "/Project-add-image/nw yr 2.jpg", "/Project-add-image/nw yr 3.jpg", "/Project-add-image/nw yr 4.jpg", "/Project-add-image/Poster 1.jpg", "/Project-add-image/Poster 2.jpg", "/Project-add-image/Poster 3.jpg",
            "/Project-add-image/poster 4.1.jpg", "/Project-add-image/Poster 5.jpg", "/Project-add-image/Poster 6.jpg"],
    ...
    2: {
        ...
        heroImage: "",
        gallery: [
            { type: 'image', url: "/Project-add-image/Web-1.png", href: "https://arrowsdesign.me", buttonText: "View" },
