                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={`rounded-xl transition-all duration-300 ${
                        focusedField === 'name' ? 'ring-2 ring-primary shadow-glow' : ''
                      }`}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      required
                      rows={6}
                      className={`rounded-xl transition-all duration-300 resize-none ${
                        focusedField === 'message' ? 'ring-2 ring-primary shadow-glow' : ''
                      }`}
                    />
                  </div>
